...
export const courses: Course[] = [
  {
    ...
    unitEn: "dishes",
    unitTh: "รายการ",
    descEn: "Suan Zen's course for younger diners, recommended for ages 7–11. Nine items: yuzu juice, tamago, salmon, hamachi and chūtoro sushi, ebi tempura, salmon don, udon carbonara and chocolate lava.",
    descTh: "คอร์สของสวน เซน สำหรับน้อง ๆ แนะนำสำหรับอายุ 7–11 ปี มีทั้งหมด 9 รายการ ตั้งแต่น้ำยูซุ ทามาโกะ แซลมอน ซูชิฮามาจิ และชูโทโร่ ไปจนถึงกุ้งเทมปุระ ข้าวหน้าแซลมอน อุด้งคาโบนาร่า และช็อกโกแลตลาวา",
    forEn: "FOR YOUNGER DINERS · AGES 7–11",
    forTh: "สำหรับน้อง ๆ อายุ 7–11 ปี",
    listLabelEn: "ALL NINE, IN ORDER",
    listLabelTh: "ครบทั้ง 9 รายการ ตามลำดับเสิร์ฟ",
    listIsPartial: false,
    photos: [],
    dishes: [
      { nameEn: "Yuzu juice" },
  ...
  },
  {
    ...
    unitEn: "dishes",
    unitTh: "รายการ",
    descEn: "Recommended for diners aged 12–14: the step between Zen Kids and the adult courses. Fourteen items, mostly sushi and seafood — madai, shima-aji, ama-ebi, akami, chūtoro, uni, kisu tempura, kani meshi — with one wagyu sushi.",
    descTh: "แนะนำสำหรับอายุ 12–14 ปี เป็นก้าวต่อจาก เซน คิดส์ ก่อนถึงคอร์สของผู้ใหญ่ มีทั้งหมด 14 รายการ ส่วนใหญ่เป็นซูชิและอาหารทะเล เช่น มาได ชิมาอาจิ อามาเอบิ อากามิ ชูโทโร่ อูนิ คิสุเทมปุระ และข้าวปู มีวากิวซูชิหนึ่งคำ",
    forEn: "RECOMMENDED FOR AGES 12–14",
    forTh: "แนะนำสำหรับอายุ 12–14 ปี",
    listLabelEn: "ALL FOURTEEN, IN ORDER",
    listLabelTh: "ครบทั้ง 14 รายการ ตามลำดับเสิร์ฟ",
    listIsPartial: false,
  ...
  },
  {
    ...
    unitEn: "dishes",
    unitTh: "รายการ",
    descEn: "The restaurant calls it a course that brings happiness: sixteen items built on ingredients that are hard to find. Mostly fish and seafood — chūtoro and ōtoro, uni, unagi — with one wagyu dish.",
    descTh: "ทางร้านบอกว่าเป็นคอร์สที่ให้ความสุข มี 16 รายการจากวัตถุดิบที่หาไม่ง่าย ส่วนใหญ่เป็นปลาและอาหารทะเล เช่น ชูโทโร่ โอโทโร่ อูนิ และอุนางิ มีวากิวหนึ่งจาน",
    forEn: "ADULT COURSE · MOSTLY FISH & SEAFOOD",
    forTh: "คอร์สผู้ใหญ่ · เน้นปลาและอาหารทะเล",
    listLabelEn: "ALL SIXTEEN, IN ORDER",
    listLabelTh: "ครบทั้ง 16 รายการ ตามลำดับเสิร์ฟ",
    listIsPartial: false,
    photos: [
  ...
  },
  {
    ...
    unitEn: "dishes",
    unitTh: "รายการ",
    descEn: "Seventeen items, the most of any course. The restaurant calls it its “fine” course, where Western and Eastern flavours meet. Mostly fish and seafood — kinmedai, akami, ōtoro, uni, amadai — with one wagyu dish.",
    descTh: "17 รายการ มากที่สุดในทุกคอร์ส ทางร้านเรียกว่าคอร์ส “ไฟน์” ที่รสชาติตะวันตกและตะวันออกมาบรรจบกัน ส่วนใหญ่เป็นปลาและอาหารทะเล เช่น คินเมได อากามิ โอโทโร่ อูนิ และอามาได มีวากิวหนึ่งจาน",
    forEn: "ADULT COURSE · MOSTLY FISH & SEAFOOD",
    forTh: "คอร์สผู้ใหญ่ · เน้นปลาและอาหารทะเล",
    listLabelEn: "ALL SEVENTEEN, IN ORDER",
    listLabelTh: "ครบทั้ง 17 รายการ ตามลำดับเสิร์ฟ",
    listIsPartial: false,
    photos: [
  ...
  },
  {
    ...
    unitEn: "dishes",
    unitTh: "รายการ",
    descEn: "Twelve items: sashimi, sushi from kampachi to ōtoro, botan ebi and an uni handroll. Two dishes are yours to choose — Wagyu Sun or grilled hotate, foie gras or king crab — and so is dessert.",
    descTh: "มี 12 รายการ ทั้งซาชิมิ ซูชิตั้งแต่คัมปาจิถึงโอโทโร่ กุ้งโบตัน และแฮนด์โรลอูนิ ระหว่างมื้อเลือกเองได้สองจาน คือวากิวซันหรือโฮตาเตะย่าง และฟัวกราส์หรือปูทาราบะ แล้วเลือกของหวานได้เอง",
    forEn: "ADULT COURSE · TWO DISHES TO CHOOSE",
    forTh: "คอร์สผู้ใหญ่ · เลือกเองได้สองจาน",
    listLabelEn: "ALL TWELVE, IN ORDER",
    listLabelTh: "ครบทั้ง 12 รายการ ตามลำดับเสิร์ฟ",
    listIsPartial: false,
    photos: [
  ...
  },
  {
    ...
    unitEn: "dishes",
    unitTh: "รายการ",
    descEn: "The restaurant's course for meat lovers: Kagoshima and Saga wagyu from Kyushu in ten of its thirteen items — tataki, sushi, roll, nabe, porridge, yakiniku, katsu, don and more. It opens with sake, or a starter instead.",
    descTh: "คอร์สที่ทางร้านทำมาสำหรับคนรักเนื้อ ใช้วากิวคาโกชิมะและซากะจากคิวชู 10 จาก 13 รายการ ทั้งทาทากิ ซูชิ โรล นาเบะ ข้าวต้ม ยากินิกุ คัตสึ ดง และอีกหลายแบบ เปิดด้วยสาเก หรือเปลี่ยนเป็นจานเรียกน้ำย่อยก็ได้",
    forEn: "ADULT COURSE · FOR BEEF LOVERS",
    forTh: "คอร์สผู้ใหญ่ · สำหรับคนรักเนื้อ",
    listLabelEn: "ALL THIRTEEN, IN ORDER",
    listLabelTh: "ครบทั้ง 13 รายการ ตามลำดับเสิร์ฟ",
    listIsPartial: false,
    photos: [
